...
def detect_holes_by_deep_valleys(y, sr):
    ...
    # =========================================================
    holes = []
    valley_to_localpeak = local_peaks  # uso posterior
    ...
    # =========================================================
    # AJUSTE DOS INÍCIOS (corrigido para furos subsequentes e último furo)
    # =========================================================
    refined_holes = []
    ...
    for idx, (s, e) in enumerate(holes):
        ...
        # 3) primeiro furo no início do arquivo
        if s_frame < search_window_start:
            s_new_frame = 0
        ...
        # 5) último furo vai até o final do arquivo
        if idx == len(holes) - 1:
            e = len(y)
...
if __name__ == "__main__":
    ...
    FILEPATH = "data/standardized/06/06_ultrasonic_190514_001_Tr3_ch1_int.wav"  # substitua pelo seu arquivo
    ...
    plot_diagnostics_with_valleys(rms_norm, diff, valleys_all, valleys_kept, depths, drop_peaks, hop_length, sr, holes)
