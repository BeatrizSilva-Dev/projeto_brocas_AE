...
# --- ESCOLHA QUAL RELATÓRIO GERAR (Descomente um por vez) ---
...
def main():
    ...
    # (Nota: O script de avaliação salva 'source' como 'segmented' ou 'augmented')
    ...
    # Seleciona as colunas principais para o relatório (As mais importantes para sua tese)
    ...
    # Adiciona prefixos para ficar claro no Excel
