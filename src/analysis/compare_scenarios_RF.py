...
# --- NOMES DOS ARQUIVOS (Padrão Random FOREST) ---
...
def main():
    print("--- Gerando Comparativo RANDOM_FOREST ---")
    ...
    plt.title('RANDOM FOREST: Comparação de Estratégias', fontsize=14)
    ...
    plt.title('Evolução da Otimização (RANDOM FOREST)', fontsize=14)
