...
# Tenta importar bibliotecas específicas (DEAP e OPTUNA)
try:
...
# =====================================================
# SETUP DO DEAP (Só roda se for usar DEAP)
# =====================================================
...
# Wrapper para o DEAP (que espera retornar tupla)
...
def main():
    ...
    if OPTIMIZATION_METHOD == "DEAP":
        ...
        for gen in range(1, GENERATIONS + 1):
            ...
            # Salva no CSV (apenas o melhor da geração para economizar espaço ou todos se preferir)
